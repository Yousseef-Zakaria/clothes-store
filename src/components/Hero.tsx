...
//       {/* Background - Solid Black with Subtle Grain Only */}
...
//         {/* Subtle glowing orb behind the image on the left side */}
//         <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-lime-400/5 rounded-full blur-[100px] pointer-events-none"></div>
//       </div>
...
//           <ul className="hidden md:flex space-x-10 font-medium text-sm tracking-widest uppercase" dir="rtl">
...
//           <button className="flex items-center gap-2 bg-white text-black px-5 py-2 md:py-2.5 rounded-full font-bold text-sm hover:bg-lime-400 hover:shadow-[0_0_15px_rgba(163,230,53,0.4)] transition-all">
//             <ShoppingBag size={18} />
...
//       {/* dir="rtl" naturally puts the first DOM element on the right, and the second on the left */}
...
//         {/* RIGHT SIDE: Typography & CTAs (Stacks on top for mobile) */}
//         <div className="w-full lg:w-1/2 flex flex-col justify-center items-start pt-10 lg:pt-0 z-20">
//           <motion.div 
...
//             className="mt-10 lg:mt-12 flex flex-col sm:flex-row gap-4 sm:gap-6 w-full sm:w-auto"
//           >
//             <button className="bg-lime-400 text-black px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:scale-105 hover:shadow-[0_0_30px_rgba(163,230,53,0.5)] transition-all duration-300 w-full sm:w-auto text-center">
//               عرض كل المنتجات
//             </button>
//             <button className="backdrop-blur-sm bg-white/5 border border-white/20 px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-all duration-300 w-full sm:w-auto text-center">
//               التصفيات
//             </button>
//           </motion.div>
//         </div>

// {/* LEFT SIDE: Single Animated Image (Stacks on bottom for mobile) */}
//         <div className="w-full lg:w-1/2 flex justify-center items-center relative mt-10 lg:mt-0 h-[40vh] lg:h-auto z-10" dir="ltr">
...
//                 {/* Aspect Ratio Container for proper fit */}
//                 {/* MODIFIED: Added a rich radial/linear gradient background so transparent images look like they are in a studio */}
...
//                   {/* Inner Border/Stroke for that 'tech-wear' detail */}
//                   <div className="absolute inset-0 z-10 border border-white/5 rounded-[2rem] pointer-events-none"></div>

//                   {/* THE IMAGE: Enhanced fitting and effect */}
//                   {/* MODIFIED: Added 'object-top' so tall fashion photos don't cut off the model's head */}
//                   <img 
//                     src="heroSection.jpg" 
...
//                   {/* Subtle vignette/gradient over the image for better text/accent visibility */}
//                   <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/80 via-transparent to-transparent z-10"></div>
//                 </div>

//                 {/* Hype accent: Slightly repositioned and more subtle to fit the new frame */}
...
//                 </div>
//               </div>
//               {/* --- NEW FRAME CODE ENDS HERE --- */}

//             </motion.div>

//             {/* Hype/Tech Design Elements surrounding the image */}
//             <motion.div 
//               animate={{ rotate: 360 }}
...
//       {/* Infinite Scrolling Marquee Banner at Bottom */}
      ...
      <div className="relative z-20 flex flex-col lg:flex-row items-center justify-between min-h-screen px-6 md:px-12 max-w-7xl mx-auto pt-24 pb-24 gap-12" dir="rtl">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center lg:items-start pt-10 lg:pt-0 z-20 text-center lg:text-right">
          ...
          >
            ...
            <button className="bg-white/5 border border-white/20 text-white hover:bg-white hover:text-black px-8 py-4 rounded-full font-bold uppercase tracking-wider transition-all duration-300 w-full sm:w-auto text-center backdrop-blur-sm">
              التصفيات
            </button>
          </motion.div>
        </div>
